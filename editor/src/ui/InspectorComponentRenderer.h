...
public:
	...
	void draw_script_component(const Origo::RID& entity, Origo::ScriptComponentInstance& instance);
...
private:
	...
	bool draw_header_scripted(const Origo::RID& entity, Origo::ScriptComponentInstance& instance, const Origo::ScriptComponentDescriptor& desc, const char* label, Origo::Ref<Origo::Texture2D> icon);
