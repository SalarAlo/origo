#include "origo/components/systems/BoxColliderComponentDebugGizmoSystem.h"
...
void BoxColliderComponentDebugGizmoSystem::render(Scene* scene, RenderContext& render_ctx) {
...
REGISTER_RENDER_SYSTEM(Origo::GamePhase::RenderEditor, Origo::BoxColliderComponentDebugGizmoSystem);
