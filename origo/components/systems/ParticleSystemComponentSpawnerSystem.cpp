#include "origo/components/systems/ParticleSystemComponentSpawnerSystem.h"
...
void ParticleSystemComponentSpawnerSystem::update(Origo::Scene* scene, float dt) {
...
REGISTER_UPDATE_SYSTEM(
    ...
    Origo::ParticleSystemComponentSpawnerSystem);
