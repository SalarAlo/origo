#include "origo/components/systems/ParticleSystemComponentTransformInjecter.h"
...
void ParticleSystemComponentTransformInjecter::update(Origo::Scene* scene, float dt) {
...
REGISTER_UPDATE_SYSTEM(
    ...
    Origo::ParticleSystemComponentTransformInjecter);
}
